module.exports = {
    ...
    , view: "lavico/templates/lookbook/productThere.html"
...
//                    }
    ...
    viewIn:function(){
        var show = $(".show_lookbook");
        var hide = $(".hide_lookbook");
        $(".slide_top_but").click(function () {
            if (show.css("display") == "none") {
                show.show();
                var show_H = show.height();
                $(".slide_bottom").animate({ "height": show_H }, 600);
                $(this).css({ "background": "url(/lavico/public/images/slide_bottom.png) no-repeat", "background-size": "contain" });
                hide.hide();
            } else {
                $(".slide_bottom").animate({ "height": "0px" }, 600);
                $(this).css({ "background": "url(/lavico/public/images/slide_top.png) no-repeat", "background-size": "contain" });
                show.hide();
                hide.show();
            }
        });
