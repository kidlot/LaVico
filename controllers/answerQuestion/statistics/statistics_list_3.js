module.exports={
    layout:"welab/Layout",
    view:"lavico/templates/answerQuestion/statistics/statistics_list_3.html",
    ...
    children:{
        page:{
            layout: "welab/Layout",
            view: "lavico/templates/answerQuestion/statistics/statistics_listPage_3.html",
            process:function(seed,nut){
                var then=this;
                var themeArr=[];
                this.step(function(){
                    helper.db.coll("lavico/themeQuestion").find({themeType:3}).toArray(this.hold(function(err,docs){
                        if(err) throw  err;
                        if(docs){
                            return docs;
                        }
