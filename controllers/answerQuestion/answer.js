        ...
        this.step(function(){
            ...
            helper.db.coll("welab/customers").findOne({"wechatid":wechatid},this.hold(function(err,result){
                ...
                if(member_id=="undefined"){
                    nut.view.disable();
                    nut.write("<script>window.onload=function(){window.popupStyle2.on('请先申请会员或者绑定会员,然后参加活动!',function(event){location.href='/lavico/member/index?wxid="+wechatid+"'})}</script>");
