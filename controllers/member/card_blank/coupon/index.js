...
module.exports = {
    ...
    view:'lavico/templates/member/card_blank/coupon/index.html',
        ...
        this.step(function(){
            ...
            helper.db.coll('welab/customers').findOne({wechatid:wxid},this.hold(function(err, doc){
                ...
                if(!doc){
                    ...
                    nut.model.info = "wxid_no_bind_welab";
                    ...
                    if(doc && doc.HaiLanMemberInfo && doc.HaiLanMemberInfo.memberID && doc.HaiLanMemberInfo.action=='bind'){
                        ...
                        member_id = "undefined";
                        nut.model.error = "null" ;
                        nut.model.info = "member_id_undefined" ;
                    }
        ...
        this.step(function(){
            ...
            this.step(function(){
                ...
                for(var _i=0;_i<_coupons.length;_i++){
                    ...
                    var _BIND_DATE  = formatTime(_coupons[_i].BIND_DATE);
