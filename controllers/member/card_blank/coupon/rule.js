/**
 * Created by David Xu on 8/20/14.
 */
/**
...
module.exports = {
        ...
        getCouponInfo:{
            ...
            process: function (seed, nut) {
                ...
                this.step(function(){
                    ...
                    middleware.request( "Coupon/GetCouponsForOpenid", requestData,this.hold(function(err,doc){
    ...
    viewIn:function(){
        ...
        window.getCouponInfo = function(){
            //请求活动信息
            $.ajax({
                url:'/lavico/member/card_blank/coupon/rule:getCouponInfo',
                type:'GET',
                dataType:'json',
                data:{
                    'wxid':$('#wxid').val(),
